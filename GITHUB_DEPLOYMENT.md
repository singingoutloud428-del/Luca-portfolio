...
For normal portfolio updates, you usually do **not** need to change GitHub at all. Use `/login.html` to update your biography, credits, skills, gallery, CV and showreel. Those changes are stored through Netlify rather than being committed to the repository.
